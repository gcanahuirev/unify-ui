<template>
  ...
  <p>
    ...
    <strong>Unify</strong> ("<strong>Company</strong>" "<strong>we</strong>,"
    "<strong>us</strong>," or “<strong>our</strong>”), concerning your access to
  ...
  <strong style="font-size: 20px">2. INTELLECTUAL PROPERTY RIGHTS</strong>
  <p>
  ...
  <strong style="font-size: 20px">3. USER REPRESENTATIONS</strong>
  <p>
  ...
  <strong style="font-size: 20px">4. USER REGISTRATION</strong>
  <p>
  ...
  <strong style="font-size: 20px">5. COPYRIGHT INFRINGEMENTS</strong>
  <p>
  ...
  <strong style="font-size: 20px">6. CONTACT US</strong>
  <p>
    We are students from Universidad Nacional de Ingeniería. In order to resolve
    a complaint regarding the Site or to receive further information regarding
    use of the Site, please contact us at:
  </p>

  <p>
    <strong> hachac@uni.pe </strong>
  </p>

  <p>
    <strong> giuseppe.canahire.v@uni.pe </strong>
  </p>
  <p>
    <strong> diego.hurtadodemendoza.g@uni.pe </strong>
  </p>
</template>
